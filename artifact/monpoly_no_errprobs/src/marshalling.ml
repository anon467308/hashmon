...
let ext_to_m ff =
  ...
  let rec e2m = function
    ...
    | ESinceA        (c1, c2, intv, ext1, ext2, sainf) -> MSinceA      (c1, c2, intv, (e2m ext1), (e2m ext2), sainf)
    | ESince         (c1, c2, intv, ext1, ext2, sinf)  -> MSince       (c1, c2, intv, (e2m ext1), (e2m ext2), sinf)
    ...
    | ENUntil        (c1, c2, p, intv, ext1, ext2, uninf) -> MNUntil   (c1, c2, p, intv, (e2m ext1), (e2m ext2), (mune2m uninf))
    | EUntil         (c1, c2, intv, ext1, ext2, uinf)  -> MUntil       (c1, c2, intv, (e2m ext1), (e2m ext2), (mue2m uinf))
...
let m_to_ext mf =
  ...
  let rec m2e = function
    ...
    | MSinceA        (c1, c2, intv, mf1, mf2, sainf)  -> ESinceA      (c1, c2, intv, (m2e mf1), (m2e mf2), sainf)
    | MSince         (c1, c2, intv, mf1, mf2, sinf)   -> ESince       (c1, c2, intv, (m2e mf1), (m2e mf2), sinf)
    ...
    | MNUntil        (c1, c2, p, intv, mf1, mf2, muninf) -> ENUntil   (c1, c2, p, intv, (m2e mf1), (m2e mf2), (mun2e muninf))
    | MUntil         (c1, c2, intv, mf1, mf2, muinf)  -> EUntil       (c1, c2, intv, (m2e mf1), (m2e mf2), (mu2e muinf))
